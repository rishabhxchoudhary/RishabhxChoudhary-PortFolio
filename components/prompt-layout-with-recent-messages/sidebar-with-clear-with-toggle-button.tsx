            ...
            >
              <div className="flex w-full items-center gap-3">
                ...
                <div className="flex flex-col text-left">
                  <p className="text-small font-semibold leading-5 text-foreground">Rishabh Kumar</p>
                  <p className="text-tiny text-default-400">rishabh26072003@gmail.com</p>
                </div>
              </div>
            </Button>
          </DropdownTrigger>
          ...
          >
            <DropdownItem key="profile" className="h-14">
              <div className="flex w-full items-center gap-3">
                ...
                />
                <div className="flex flex-col text-left">
                  <p className="text-small font-normal leading-5 text-foreground">Rishabh Kumar</p>
                  <p className="text-tiny text-default-400">rishabh26072003@gmail.com</p>
                </div>
              </div>
            </DropdownItem>
            <DropdownSection showDivider aria-label="profile-section-1" className="px-0">
              ...
              <DropdownItem key="customize-Rishabhai" className="py-[4px] text-default-500">
                Customize RishabhAI
              </DropdownItem>
            </DropdownSection>
